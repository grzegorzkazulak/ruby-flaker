Gem::Specification.new do |s|
  ...
  s.files = ["Manifest", "API.txt", "History.txt", "README.markdown", "VERSION.yml", "lib/flaker", "lib/flaker/base.rb", "lib/flaker/wrapper.rb", "spec/flaker_spec", "spec/spec_helper", "spec/spec.opts"]
  s.has_rdoc = true
